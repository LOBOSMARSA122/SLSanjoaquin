...
namespace Sigesoft.Server.WebClientAdmin.UI.Servicios
{
    public partial class FRM040 : System.Web.UI.Page
    {
        ...
        protected void btnGrabarAptitud_Click(object sender, EventArgs e)
        {
            ...
            _serviceBL.ActualizarAptitudServicio(ref objOperationResult, Session["ServiceId"].ToString(), int.Parse(ddlAptitud.SelectedValue.ToString()), ((ClientSession)Session["objClientSession"]).GetAsList(), txtComentarioAptitud.Text, txtComentarioMedico.Text, txtRestriccionesAptitud.Text);
