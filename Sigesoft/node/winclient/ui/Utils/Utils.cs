...
namespace Sigesoft.Node.WinClient.UI
{
    public class Utils
    {
        ...
        public static void LoadDropDownList(ComboBox prmDropDownList, string prmDataTextField = null, string prmDataValueField = null, List<FrmEsoV2.StructKeyDto> prmDataSource = null, DropDownListAction? prmDropDownListAction = null)
        {
