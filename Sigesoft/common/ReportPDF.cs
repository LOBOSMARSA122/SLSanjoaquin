    ...
    {         
        ...
        public static void CreateMedicalReportEPS(PacientList filiationData, List<PersonMedicalHistoryList> personMedicalHistory, List<NoxiousHabitsList> noxiousHabit, List<FamilyMedicalAntecedentsList> familyMedicalAntecedent, ServiceList anamnesis, List<ServiceComponentList> serviceComponent, List<DiagnosticRepositoryList> diagnosticRepository, string filePDF)
        {
            ...
            try
            {
                ...
                Font fontTitleTableNegro = FontFactory.GetFont("Calibri", 7, iTextSharp.text.Font.NORMAL, new BaseColor(System.Drawing.Color.Black));
        ...
        public static void CreateMedicalReportForTheWorker(PacientList filiationData, List<PersonMedicalHistoryList> personMedicalHistory, List<NoxiousHabitsList> noxiousHabit, List<FamilyMedicalAntecedentsList> familyMedicalAntecedent, ServiceList anamnesis, List<ServiceComponentList> serviceComponent, List<DiagnosticRepositoryList> diagnosticRepository, string customerOrganizationName, organizationDto infoEmpresaPropietaria,string filePDF)
        {
            ...
            try
            {
                ...
                Font fontTitleTableNegro = FontFactory.GetFont("Calibri", 7, iTextSharp.text.Font.NORMAL, new BaseColor(System.Drawing.Color.Black));
                Font fontSubTitle = FontFactory.GetFont("Calibri", 7, iTextSharp.text.Font.NORMAL, new BaseColor(System.Drawing.Color.White));
                Font fontSubTitleNegroNegrita = FontFactory.GetFont("Calibri", 7, iTextSharp.text.Font.NORMAL, new BaseColor(System.Drawing.Color.Black));
     ...
     #region Declaration Tables
            ...
            { 
                ...
                if (personMedicalHistory.Count == 0)
                {
                    personMedicalHistory.Add(new PersonMedicalHistoryList { v_DiseasesName = "NO REFIERE ANTECEDENTES MÉDICOS PERSONALES." });
                    columnWidths = new float[] { 100f };
                    include = "v_DiseasesName";
                }
                else
                ...
                var antMedicoPer = HandlingItextSharp.GenerateTableFromList(personMedicalHistory, columnWidths, include, fontColumnValue, "II. ANTECEDENTES MÉDICOS PERSONALES", fontTitleTableNegro);
                ...
                if (filiationData.FirmaDoctorAuditor != null)
                    cellFirma = new PdfPCell(HandlingItextSharp.GetImage(filiationData.FirmaDoctorAuditor, null, null, 100, 35));
                else
        ...
        private static PdfPTable TableBuilderReportForTheWorker(ServiceComponentList serviceComponent, Font fontTitle, Font fontSubTitle, Font fontColumnValue, BaseColor SubtitleBackgroundColor, List<DiagnosticRepositoryList> diagnosticRepository)
        {
            ...
            switch (serviceComponent.v_ComponentId)
            {
                ...
                case Sigesoft.Common.Constants.EXAMEN_FISICO_ID:
                    ...
                    break;
                case Sigesoft.Common.Constants.AUDIOMETRIA_SJ_ID:
                ...
                case Sigesoft.Common.Constants.PERFIL_LIPIDICO:
                    ...
                    if (serviceComponent.ServiceComponentFields.Count > 0)
                    {
                        ...
                        cells.Add(new PdfPCell(new Phrase(string.IsNullOrEmpty(descripcionTriglicerido.v_Value1) ? "" : "TRIGLICÉRIDOS: " + descripcionTriglicerido.v_Value1 + " (mg/dl)", fontColumnValue)));
                                        ...
                                        string filePDF)
        {
            ...
            Font fontTitle1 = FontFactory.GetFont("Calibri", 10, iTextSharp.text.Font.NORMAL, new BaseColor(System.Drawing.Color.Black));
            Font fontTitle2 = FontFactory.GetFont("Calibri", 7, iTextSharp.text.Font.NORMAL, new BaseColor(System.Drawing.Color.Black));
            Font fontTitleTable = FontFactory.GetFont("Calibri", 6, iTextSharp.text.Font.NORMAL, new BaseColor(System.Drawing.Color.Black));
            Font fontTitleTableNegro = FontFactory.GetFont("Calibri", 6, iTextSharp.text.Font.NORMAL, new BaseColor(System.Drawing.Color.Black));
            Font fontSubTitle = FontFactory.GetFont("Calibri", 6, iTextSharp.text.Font.NORMAL, new BaseColor(System.Drawing.Color.White));
            Font fontSubTitleNegroNegrita = FontFactory.GetFont("Calibri", 6, iTextSharp.text.Font.NORMAL, new BaseColor(System.Drawing.Color.Black));

            Font fontColumnValue = FontFactory.GetFont("Calibri", 7, iTextSharp.text.Font.NORMAL, new BaseColor(System.Drawing.Color.Black));
            Font fontColumnValueBold = FontFactory.GetFont("Calibri", 6, iTextSharp.text.Font.NORMAL, new BaseColor(System.Drawing.Color.Black));
