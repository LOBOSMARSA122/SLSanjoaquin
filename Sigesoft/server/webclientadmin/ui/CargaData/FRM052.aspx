    ...
    <x:Panel ID="Panel1" runat="server" Layout="Fit" ShowBorder="False" ShowHeader="false" BodyPadding="5px" EnableBackgroundColor="true">
        <Toolbars>
            <x:Toolbar ID="Toolbar1" runat="server">
                <Items>
                    <x:Button ID="btnSaveRefresh" Text="Agregar y Cerrar" runat="server" Icon="SystemSave" OnClick="btnSaveRefresh_Click" ValidateForms="SimpleForm1" TabIndex="7">
                    </x:Button>
            ...
            <x:Panel ID="Panel2" Layout="Fit" runat="server" ShowBorder="false" ShowHeader="false" >
                <Items>
                    <x:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false" EnableBackgroundColor="true" 
                        ...
                        <Items>    
                            <x:TextBox ID="txtNombres" Label="Nombres" runat="server" Required="true" TabIndex="1" ShowRedStar="true"  />
                            <x:TextBox ID="txtApellidoPaterno" Label="Ape. Paterno" runat="server"  Required="true"  ShowRedStar="true"  TabIndex="2"    />
                            <x:TextBox ID="txtApellidoMaterno" Label="Ape. Materno" runat="server" Required="true"  ShowRedStar="true"  TabIndex="3"   />
                            ...
                            <x:DropDownList ID="ddlDocumento"  runat="server" Width="150" Label="Documento" Resizable="True"  ShowRedStar="true"  Required="true" CompareType="String" CompareValue="-1"
                                                    CompareOperator="NotEqual" CompareMessage="Campo requerido"></x:DropDownList>    
                            <x:TextBox ID="txtNroDocumento" Label="Nro. Doc." runat="server" Required="true" TabIndex="3"  ShowRedStar="true"    />
                            <x:DatePicker ID="dpFechaNacimiento" Label="Fecha Nacim." Width="90px" Required="true" runat="server"  ShowRedStar="true"  DateFormatString="dd/MM/yyyy" />
                            <%--<x:DropDownList ID="ddlProtocoloId" runat="server"  Label="Protocolo" Width="240px"></x:DropDownList>--%>     
                            <x:TextBox ID="txtPuesto" Label="Puesto" runat="server" Required="true" TabIndex="1" ShowRedStar="true" />
                        </Items>
                    </x:SimpleForm>
                </Items>
            </x:Panel>
