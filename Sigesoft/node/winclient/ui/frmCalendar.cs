    ...
    public partial class frmCalendar : Form
    {
        ...
        private List<CalendarList> GetData(int pintPageIndex, int? pintPageSize, string pstrSortExpression, string pstrFilterExpression)
        {
            ...
            DateTime? pdatEndDate = dptDateTimeEnd.Value.Date.AddDays(1);
             ...
             _objData = _objCalendarBL.GetCalendarsPagedAndFiltered(ref objOperationResult, pintPageIndex, pintPageSize, pstrSortExpression, pstrFilterExpression, pdatBeginDate, pdatEndDate,chkIsCampania.Checked?1:0);
        ...
        private void btnAgregarAdiconal_Click_1(object sender, EventArgs e)
        {
            ServiceBL oServiceBL = new ServiceBL();
            var frm = new frmAddAdditionalExam();
            frm._serviceId = _serviceId;
        ...
        private void btnRemoverEsamen_Click_1(object sender, EventArgs e)
        {
