...
<body>
    ...
    <x:Pagemanager ID="PageManager1" runat="server" AutoSizePanelID="Panel1"/>
           <x:Panel ID="Panel1" runat="server"  ShowBorder="True" ShowHeader="True" Title="Carga Masiva" EnableBackgroundColor="true" Layout="VBox" 
                  ...
                  <Toolbars>
                    <x:Toolbar ID="Toolbar1" runat="server">
                        <Items>
                            ...
                            <%--<x:Button ID="btnAsignarProtocolo" runat="server" Text="Asignar Protocolo" Icon="Add"></x:Button>--%>
                        </Items>
                    </x:Toolbar>
                </Toolbars>   
                <Columns>   
    ...
    <x:Window ID="Window1" Title="Asignar Protocolo" Popup="false" EnableIFrame="true" runat="server" Icon="UserBrown"
        CloseAction="HidePostBack" EnableConfirmOnClose="true" IFrameUrl="about:blank" EnableMaximize="false" EnableResize="false" 
