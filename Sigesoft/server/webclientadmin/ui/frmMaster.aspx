        ...
        <x:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                <x:Region ID="Region1" Margins="0 0 0 0" Height="60px" ShowBorder="false" ShowHeader="false"
                    ...
                    <Items>
                        <x:ContentPanel ShowBorder="false" CssClass="header" ShowHeader="false" BodyStyle="background-color:#04B486;"
                            ID="ContentPanel1" runat="server">
                            <table>
                                <tr>
                                    <td class="title">
                                        <x:HyperLink ID="HyperLink3" NavigateUrl="~/frmMaster.aspx" runat="server" Text="">
                                        </x:HyperLink>
                                    </td>
