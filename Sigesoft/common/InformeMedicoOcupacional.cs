   ...
   public class InformeMedicoOcupacional
    {
           ...
           string RecoOsteoMus1, string RecoTamDer, string RecoOdon, string RecoPsico, string RecoRx, string RecoOit, string RecoOft, string Restricciton, string Aptitud)
       {
           ...
           try
           {
                ...
                Font fontTitle1 = FontFactory.GetFont("Calirbi", 10, iTextSharp.text.Font.NORMAL, new BaseColor(System.Drawing.Color.Black));
                Font fontTitle2 = FontFactory.GetFont("Calirbi", 8, iTextSharp.text.Font.NORMAL, new BaseColor(System.Drawing.Color.Black));
                Font fontTitleTable = FontFactory.GetFont("Calirbi", 8, iTextSharp.text.Font.BOLD, new BaseColor(System.Drawing.Color.White));
                Font fontTitleTableNegro = FontFactory.GetFont("Calirbi", 8, iTextSharp.text.Font.BOLD, new BaseColor(System.Drawing.Color.Black));
                Font fontSubTitle = FontFactory.GetFont("Calirbi", 8, iTextSharp.text.Font.BOLD, new BaseColor(System.Drawing.Color.White));
                Font fontSubTitleNegroNegrita = FontFactory.GetFont("Calirbi", 8, iTextSharp.text.Font.BOLD, new BaseColor(System.Drawing.Color.Black));

                Font fontColumnValue = FontFactory.GetFont("Calirbi", 8, iTextSharp.text.Font.NORMAL, new BaseColor(System.Drawing.Color.Black));
          ...
          #region CABECERA DETALLE 2
                ...
                if (xFactorSan != null)
                {
                    ...
                    cells = new List<PdfPCell>()
                    {
                        new PdfPCell(new Phrase("GRUPO Y FACTOR SANGUÍNEO", fontColumnValue)){HorizontalAlignment = Element.ALIGN_RIGHT, Rowspan=2 }, 
                        ...
                        new PdfPCell(new Phrase("FACTOR: "+ Factor == null ? string.Empty :"FACTOR: "+  Factor.v_Value1Name, fontColumnValue)){HorizontalAlignment = Element.ALIGN_LEFT },     
                        new PdfPCell(new Phrase("", fontColumnValue)){HorizontalAlignment = Element.ALIGN_CENTER },       
                        new PdfPCell(new Phrase("", fontColumnValue)){HorizontalAlignment = Element.ALIGN_CENTER },       
