...
namespace Sigesoft.Node.WinClient.BLL
{
    public class PacientBL
    {
                           ...
                           select new ServiceList
                            {
                                ...
                                Afectividad = Psico.Count == 0 || Psico.Find(p => p.v_ComponentFieldId == Constants.PSICOLOGIA_Afectividad) == null ? string.Empty : Psico.Find(p => p.v_ComponentFieldId == Constants.PSICOLOGIA_Afectividad).v_Value1Name,//  GetServiceComponentFielValue(a.v_ServiceId, "N002-ME000000033", "N009-MF000000634", "NOCOMBO", 0,"NO"),
            ...
            try
            {
                ...
                var sql = (from a in objEntity.ToList()
                           select new ReportAlturaEstructural
                           {
                               ...
                               AntecedenteTecSI = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_ANTECEDENTE_TEC_SI_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_ANTECEDENTE_TEC_SI_ID).v_Value1,//GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_ANTECEDENTE_TEC_SI_ID, "NOCOMBO", 0, "SI"),
                               AntecedenteTecNO = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_ANTECEDENTE_TEC_NO_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_ANTECEDENTE_TEC_NO_ID).v_Value1,//GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_ANTECEDENTE_TEC_NO_ID, "NOCOMBO", 0, "SI"),
                               AntecedenteTecObs = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_ANTECEDENTE_TEC_OBS_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_ANTECEDENTE_TEC_OBS_ID).v_Value1,//GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_ANTECEDENTE_TEC_OBS_ID, "NOCOMBO", 0, "SI"),

                               ConvulsionesSI = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_CONVULSIONES_EPILEPSIA_SI_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_CONVULSIONES_EPILEPSIA_SI_ID).v_Value1,//GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_CONVULSIONES_EPILEPSIA_SI_ID, "NOCOMBO", 0, "SI"),
                               ConvulsionesNO = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_CONVULSIONES_EPILEPSIA_NO_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_CONVULSIONES_EPILEPSIA_NO_ID).v_Value1,//GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_CONVULSIONES_EPILEPSIA_NO_ID, "NOCOMBO", 0, "SI"),
                               ConvulsionesObs = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_CONVULSIONES_EPILEPSIA_OBS_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_CONVULSIONES_EPILEPSIA_OBS_ID).v_Value1,//GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_CONVULSIONES_EPILEPSIA_OBS_ID, "NOCOMBO", 0, "SI"),

                               MareosSI = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_MAREOS_SI_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_MAREOS_SI_ID).v_Value1,//GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_MAREOS_SI_ID, "NOCOMBO", 0, "SI"),
                               MareosNO = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_MAREOS_NO_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_MAREOS_NO_ID).v_Value1,//GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_MAREOS_NO_ID, "NOCOMBO", 0, "SI"),
                               MareosObs = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_MAREOS_OBS_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_MAREOS_OBS_ID).v_Value1,//GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_MAREOS_OBS_ID, "NOCOMBO", 0, "SI"),

                               AgorafobiaSI = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_AGORAFOBIA_SI_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_AGORAFOBIA_SI_ID).v_Value1,//GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_AGORAFOBIA_SI_ID, "NOCOMBO", 0, "SI"),
                               AgorafobiaNO = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_AGORAFOBIA_NO_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_AGORAFOBIA_NO_ID).v_Value1,// GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_AGORAFOBIA_NO_ID, "NOCOMBO", 0, "SI"),
                               AgorafobiaObs = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_AGORAFOBIA_OBS_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_AGORAFOBIA_OBS_ID).v_Value1,//GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_AGORAFOBIA_OBS_ID, "NOCOMBO", 0, "SI"),

                               AcrofobiaSI = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_ACROFOBIA_SI_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_ACROFOBIA_SI_ID).v_Value1,//GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_ACROFOBIA_SI_ID, "NOCOMBO", 0, "SI"),
                               AcrofobiaNO = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_ACROFOBIA_NO_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_ACROFOBIA_NO_ID).v_Value1,//GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_ACROFOBIA_NO_ID, "NOCOMBO", 0, "SI"),
                               AcrofobiaObs = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_ACROFOBIA_OBS_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_ACROFOBIA_OBS_ID).v_Value1,//GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_ACROFOBIA_OBS_ID, "NOCOMBO", 0, "SI"),

                               InsuficienciaCardiacaSI = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_INSUFICIENCIA_CARDIACA_SI_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_INSUFICIENCIA_CARDIACA_SI_ID).v_Value1,//GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_INSUFICIENCIA_CARDIACA_SI_ID, "NOCOMBO", 0, "SI"),
                               InsuficienciaCardiacaNO = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_INSUFICIENCIA_CARDIACA_NO_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_INSUFICIENCIA_CARDIACA_NO_ID).v_Value1,//GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_INSUFICIENCIA_CARDIACA_NO_ID, "NOCOMBO", 0, "SI"),
                               InsuficienciaCardiacaObs = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_INSUFICIENCIA_CARDIACA_OBS_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_INSUFICIENCIA_CARDIACA_OBS_ID).v_Value1,//GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_INSUFICIENCIA_CARDIACA_OBS_ID, "NOCOMBO", 0, "SI"),

                               EstereopsiaSI = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_ESTEREOPSIA_SI_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_ESTEREOPSIA_SI_ID).v_Value1,// GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_ESTEREOPSIA_SI_ID, "NOCOMBO", 0, "SI"),
                               EstereopsiaNO = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_ESTEREOPSIA_NO_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_ESTEREOPSIA_NO_ID).v_Value1,//GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_ESTEREOPSIA_NO_ID, "NOCOMBO", 0, "SI"),
                               EstereopsiaObs = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_ESTEREOPSIA_OBS_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_ESTEREOPSIA_OBS_ID).v_Value1,//GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_ESTEREOPSIA_OBS_ID, "NOCOMBO", 0, "SI"),

                               NistagmusEspontaneo = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_NISTAGMUS_ESPONTANEO_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_NISTAGMUS_ESPONTANEO_ID).v_Value1,// GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_NISTAGMUS_ESPONTANEO_ID, "NOCOMBO", 0, "SI"),
                               NistagmusProvocado = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_NISTAGMUS_PROVOCADO_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_NISTAGMUS_PROVOCADO_ID).v_Value1,// GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_NISTAGMUS_PROVOCADO_ID, "NOCOMBO", 0, "SI"),

                               PrimerosAuxilios = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_PRIMEROS_AUXILIOS_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_PRIMEROS_AUXILIOS_ID).v_Value1,//GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_PRIMEROS_AUXILIOS_ID, "NOCOMBO", 0, "SI"),
                               TrabajoNivelMar = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_TRABAJO_SOBRE_NIVEL_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_TRABAJO_SOBRE_NIVEL_ID).v_Value1,// GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_TRABAJO_SOBRE_NIVEL_ID, "NOCOMBO", 0, "SI"),

                               Timpanos = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_TIMPANOS_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_TIMPANOS_ID).v_Value1,//GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_TIMPANOS_ID, "NOCOMBO", 0, "SI"),
                               Equilibrio = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_EQUILIBRIO_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_EQUILIBRIO_ID).v_Value1,// GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_EQUILIBRIO_ID, "NOCOMBO", 0, "SI"),
                               SustentacionPie20Seg = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_SUST_PIE_20_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_SUST_PIE_20_ID).v_Value1,// GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_SUST_PIE_20_ID, "NOCOMBO", 0, "SI"),
                               CaminarLibre3Mts = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_CAMINAR_LIBRE_RECTA_3_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_CAMINAR_LIBRE_RECTA_3_ID).v_Value1,// GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_CAMINAR_LIBRE_RECTA_3_ID, "NOCOMBO", 0, "SI"),
                               CaminarLibreVendado3Mts = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_CAMINAR_LIBRE_OJOS_VENDADOS_3_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_CAMINAR_LIBRE_OJOS_VENDADOS_3_ID).v_Value1,//GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_CAMINAR_LIBRE_OJOS_VENDADOS_3_ID, "NOCOMBO", 0, "SI"),
                               CaminarLibreVendadoPuntaTalon3Mts = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_CAMINAR_LIBRE_OJOS_VENDADOS_PUNTA_TALON_3_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_CAMINAR_LIBRE_OJOS_VENDADOS_PUNTA_TALON_3_ID).v_Value1,//GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_CAMINAR_LIBRE_OJOS_VENDADOS_PUNTA_TALON_3_ID, "NOCOMBO", 0, "SI"),
                               Rotar = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_ROTAR_SILLA_GIRATORIA_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_ROTAR_SILLA_GIRATORIA_ID).v_Value1,//GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_ROTAR_SILLA_GIRATORIA_ID, "NOCOMBO", 0, "SI"),
                               AdiadocoquinesiaDirecta = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_ADIADOCOQUINESIA_DIRECTA_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_ADIADOCOQUINESIA_DIRECTA_ID).v_Value1,//GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_ADIADOCOQUINESIA_DIRECTA_ID, "NOCOMBO", 0, "SI"),
                               AdiadocoquinesiaCruzada = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_ADIADOCOQUINESIA_CRUZADA_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_ADIADOCOQUINESIA_CRUZADA_ID).v_Value1,//GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_ADIADOCOQUINESIA_CRUZADA_ID, "NOCOMBO", 0, "SI"),
                               Apto = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_APTO_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_APTO_ID).v_Value1,//GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_APTO_ID, "NOCOMBO", 0, "SI"),
                               descripcion = Valores.Count == 0 || Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_DESCRIPCION_ID) == null ? string.Empty : Valores.Find(p => p.v_ComponentFieldId == Constants.ALTURA_ESTRUCTURAL_DESCRIPCION_ID).v_Value1,//GetServiceComponentFielValue(a.ServicioId, Constants.ALTURA_ESTRUCTURAL_ID, Constants.ALTURA_ESTRUCTURAL_DESCRIPCION_ID, "NOCOMBO", 0, "SI"),
                               RubricaMedico = a.RubricaMedico,
                               RubricaTrabajador = a.RubricaTrabajador,
                               HuellaTrabajador = a.HuellaTrabajador,
            ...
            try
            {
                ...
                var objEntity = (from A in dbContext.service
                                 ...
                                 select new ReportConsentimiento
                                 {
                                     ...
                                     d_ServiceDate = A.d_ServiceDate,
                                     DireccionCliente = C.v_Address,
                                     FirmaAuditor = pr2.b_SignatureImage
                ...
                var sql = (from a in objEntity.ToList()
                           ...
                           {                               
                               ...
                               v_ServiceDate = ConvertirFecha(a.d_ServiceDate),
                               Componentes = ComponetesConcatenados,
                               ComponentesLaboratorio = ComponentesLaboratorioConcatenados,
                               FechaActual = ConvertirFecha(DateTime.Now),
                               DireccionCliente = a.DireccionCliente,
        ...
        public List<ServiceComponentList> GetServiceComponentsByCategoryExceptLab(ref OperationResult pobjOperationResult, string pstrServiceId)
        {
            ...
            try
            {
                ...
                var objData = query.AsEnumerable()
                             .Where(s => s.i_CategoryId != -1 && s.i_CategoryId != 1 && s.i_CategoryId != 6 && s.i_CategoryId != 10)
        ...
        {
            string Mes = Fecha.Value.ToString("MMMM");
            string Dia = Fecha.Value.Day.ToString();
            string anio =  Fecha.Value.ToString("yyyy");
        ...
        public List<MatrizExcel> ReporteMatrizExcel(DateTime? FechaInicio, DateTime? FechaFin, string pstrCustomerOrganizationId, string pstrFilterExpression)
        {
            try
            {
                using (SigesoftEntitiesModel dbContext = new SigesoftEntitiesModel())
                {
                    ...
                    var MedicalCenter = GetInfoMedicalCenter();
                    var varDx = DevolverJerarquiaDxMejorado(ServicioIds);
                    ...
                    var sql = (from a in objEntity.ToList()
                               ...
                               let AudiometriaValores = ValoresComponenteOdontogramaValue1(a.IdServicio, Constants.AUDIOMETRIA_SJ_ID)

                               let AudiometriaDx = varDx.Find(p => p.ServicioId == a.IdServicio).DetalleDxRecomendaciones.FindAll(o => o.IdComponente == Constants.AUDIOMETRIA_SJ_ID)
                               ...
                               let UsaLentesNO = varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.OFTALMOLOGIA_ID) == null ? "NO APLICA" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.OFTALMOLOGIA_ID && o.IdCampo == Constants.OFTALMOLOGIA_CORRECTORES_OCULARES_NO_ID).Valor == "" ? "NO APLICA" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.OFTALMOLOGIA_ID && o.IdCampo == Constants.OFTALMOLOGIA_CORRECTORES_OCULARES_NO_ID).Valor == "1" ? "NO" : ""
                               let UsaLentesSI = varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.OFTALMOLOGIA_ID) == null ? "NO APLICA" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.OFTALMOLOGIA_ID && o.IdCampo == Constants.OFTALMOLOGIA_CORRECTORES_OCULARES_SI_ID).Valor == "" ? "NO APLICA" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.OFTALMOLOGIA_ID && o.IdCampo == Constants.OFTALMOLOGIA_CORRECTORES_OCULARES_SI_ID).Valor == "1" ? "SI" : ""

                               let IshiharaNormal = varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.TEST_ISHIHARA_ID) == null ? "NO APLICA" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.TEST_ISHIHARA_ID && o.IdCampo == Constants.TEST_ISHIHARA_NORMAL) == null ? "id no conincinde" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.TEST_ISHIHARA_ID && o.IdCampo == Constants.TEST_ISHIHARA_NORMAL).Valor == "" ? "NO APLICA" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.TEST_ISHIHARA_ID && o.IdCampo == Constants.TEST_ISHIHARA_NORMAL).Valor == "1" ? "Normal" : ""
                               let IshiharaAnormal = varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.TEST_ISHIHARA_ID) == null ? "NO APLICA" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.TEST_ISHIHARA_ID && o.IdCampo == Constants.TEST_ISHIHARA_ANORMAL) == null ? "id no conincinde" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.TEST_ISHIHARA_ID && o.IdCampo == Constants.TEST_ISHIHARA_ANORMAL).Valor == "" ? "NO APLICA" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.TEST_ISHIHARA_ID && o.IdCampo == Constants.TEST_ISHIHARA_ANORMAL).Valor == "1" ? "Anormal" : ""

                               let EstereopsisNormal = varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.TEST_ESTEREOPSIS_ID) == null ? "NO APLICA" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.TEST_ESTEREOPSIS_ID && o.IdCampo == Constants.OFTALMOLOGIA_TEST_ESTEREOPSIS_NORMAL_ID) == null ? "id no conincinde" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.TEST_ESTEREOPSIS_ID && o.IdCampo == Constants.OFTALMOLOGIA_TEST_ESTEREOPSIS_NORMAL_ID).Valor == "" ? "NO APLICA" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.TEST_ESTEREOPSIS_ID && o.IdCampo == Constants.OFTALMOLOGIA_TEST_ESTEREOPSIS_NORMAL_ID).Valor == "1" ? "Normal" : ""
                               let EstereopsisAnormal = varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.TEST_ESTEREOPSIS_ID) == null ? "NO APLICA" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.TEST_ESTEREOPSIS_ID && o.IdCampo == Constants.OFTALMOLOGIA_TEST_ESTEREOPSIS_ANORMAL_ID) == null ? "id no conincinde" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.TEST_ESTEREOPSIS_ID && o.IdCampo == Constants.OFTALMOLOGIA_TEST_ESTEREOPSIS_ANORMAL_ID).Valor == "" ? "NO APLICA" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.TEST_ESTEREOPSIS_ID && o.IdCampo == Constants.OFTALMOLOGIA_TEST_ESTEREOPSIS_ANORMAL_ID).Valor == "1" ? "Anormal" : ""
                               ...
                               let ColesterolDx = varDx.Find(p => p.ServicioId == a.IdServicio).DetalleDxRecomendaciones.FindAll(o => o.IdCampo == Constants.COLESTEROL_COLESTEROL_TOTAL_ID)
                               let DxColesterol = ColesterolDx == null ? null : ColesterolDx != null ? string.Join("/ ", ColesterolDx.Select(p => p.Descripcion)) : "Normal"

                               let HDLDx = varDx.Find(p => p.ServicioId == a.IdServicio).DetalleDxRecomendaciones.FindAll(o =>  o.IdCampo == Constants.COLESTEROL_HDL_BIOQUIMICA_COLESTEROL_HDL)
                               let DxHDL = HDLDx.Count == 0 ? null: HDLDx != null ? string.Join("/ ", HDLDx.Select(p => p.Descripcion)) : "Normal"

                               let LDLDx = varDx.Find(p => p.ServicioId == a.IdServicio).DetalleDxRecomendaciones.FindAll(o => o.IdCampo == Constants.COLESTEROL_LDL_BIOQUIMICA_COLESTEROL_LDL)
                               let DxLDL = LDLDx.Count == 0 ? null : LDLDx != null ? string.Join("/ ", LDLDx.Select(p => p.Descripcion)) : "Normal"

                               let VLDLx = varDx.Find(p => p.ServicioId == a.IdServicio).DetalleDxRecomendaciones.FindAll(o =>  o.IdCampo == Constants.COLESTEROL_VLDL_BIOQUIMICA_COLESTEROL_VLDL)
                               let DxVLDL = VLDLx.Count == 0 ? null : VLDLx != null ? string.Join("/ ", VLDLx.Select(p => p.Descripcion)) : "Normal"
                               ...
                               let TGCDx = varDx.Find(p => p.ServicioId == a.IdServicio).DetalleDxRecomendaciones.FindAll(o => o.IdCampo == Constants.TRIGLICERIDOS_BIOQUIMICA_TRIGLICERIDOS)
                               let DxTGC = TGCDx.Count == 0 ? null : TGCDx != null ? string.Join("/ ", TGCDx.Select(p => p.Descripcion)) : "Normal"
                               
                               //let OrinaDx = varDx.Find(p => p.ServicioId == a.IdServicio).DetalleDxRecomendaciones.FindAll(o => o.IdComponente == Constants.EXAMEN_COMPLETO_DE_ORINA_ID)
                               ...
                               select new MatrizExcel
                               {
                                   ...
                                   VisionCercaOI = varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.OFTALMOLOGIA_ID) == null ? "NO APLICA" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.OFTALMOLOGIA_ID && o.IdCampo == Constants.OFTALMOLOGIA_SC_LEJOS_OJO_IZQUIERDO_ID).Valor == "" ? "NO APLICA" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.OFTALMOLOGIA_ID && o.IdCampo == Constants.OFTALMOLOGIA_SC_LEJOS_OJO_IZQUIERDO_ID).Valor,

                                   AgudezaVisualLejosOD = varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.OFTALMOLOGIA_ID) == null ? "NO APLICA" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.OFTALMOLOGIA_ID && o.IdCampo == Constants.OFTALMOLOGIA_AGUDEZA_VISUAL_CERCA_SC_OJO_DERECHO).Valor == "" ? "NO APLICA" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.OFTALMOLOGIA_ID && o.IdCampo == Constants.OFTALMOLOGIA_AGUDEZA_VISUAL_CERCA_SC_OJO_DERECHO).Valor,
                                   AgudezaVisualLejosOI = varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.OFTALMOLOGIA_ID) == null ? "NO APLICA" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.OFTALMOLOGIA_ID && o.IdCampo == Constants.OFTALMOLOGIA_AGUDEZA_VISUAL_CERCA_SC_OJO_IZQUIERDO).Valor == "" ? "NO APLICA" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.OFTALMOLOGIA_ID && o.IdCampo == Constants.OFTALMOLOGIA_AGUDEZA_VISUAL_CERCA_SC_OJO_IZQUIERDO).Valor,
                                   VisionCercaCorregidaOD = varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.OFTALMOLOGIA_ID) == null ? "NO APLICA" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.OFTALMOLOGIA_ID && o.IdCampo == Constants.OFTALMOLOGIA_CC_LEJOS_OJO_DERECHO_ID).Valor == "" ? "NO APLICA" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.OFTALMOLOGIA_ID && o.IdCampo == Constants.OFTALMOLOGIA_CC_LEJOS_OJO_DERECHO_ID).Valor,
                                   VisionCercaCorregidaOI = varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.OFTALMOLOGIA_ID) == null ? "NO APLICA" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.OFTALMOLOGIA_ID && o.IdCampo == Constants.OFTALMOLOGIA_CC_LEJOS_OJO_IZQUIERDO_ID).Valor == "" ? "NO APLICA" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.OFTALMOLOGIA_ID && o.IdCampo == Constants.OFTALMOLOGIA_CC_LEJOS_OJO_IZQUIERDO_ID).Valor,
                                   AgudezaVisualLejosCorregidaOD = varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.OFTALMOLOGIA_ID) == null ? "NO APLICA" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.OFTALMOLOGIA_ID && o.IdCampo == Constants.OFTALMOLOGIA_AGUDEZA_VISUAL_CERCA_CC_OJO_DERECHO).Valor == "" ? "NO APLICA" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.OFTALMOLOGIA_ID && o.IdCampo == Constants.OFTALMOLOGIA_AGUDEZA_VISUAL_CERCA_CC_OJO_DERECHO).Valor,
                                   AgudezaVisualLejosCorregidaOI = varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.OFTALMOLOGIA_ID) == null ? "NO APLICA" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.OFTALMOLOGIA_ID && o.IdCampo == Constants.OFTALMOLOGIA_CC_CERCA_OJO_IZQUIERDO_ID).Valor == "" ? "NO APLICA" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == Constants.OFTALMOLOGIA_ID && o.IdCampo == Constants.OFTALMOLOGIA_CC_CERCA_OJO_IZQUIERDO_ID).Valor,
                                   ...
                                   DxColesterol = DxColesterol == null ? "NO APLICA" : DxColesterol == "" ? "NORMAL" : DxColesterol,
                                   ...
                                   DxHdl = DxHDL == null ? "NO APLICA" : DxHDL == "" ? "NORMAL" : DxHDL,
                                   ...
                                   DxTgc = DxTGC == null ? "NO APLICA" : DxTGC == "" ? "NORMAL" : DxTGC,
                                   ...
                                   Colinesterasa = varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == "N009-ME000000042") == null ? "NO APLICA" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == "N009-ME000000042" && o.IdCampo == "N009-MF000000393").Valor == "" ? "NO APLICA" : varValores.Find(p => p.ServicioId == a.IdServicio).CampoValores.Find(o => o.IdComponente == "N009-ME000000042" && o.IdCampo == "N009-MF000000393").Valor,
                ...
                using (SigesoftEntitiesModel dbContext = new SigesoftEntitiesModel())
                {
                    ...
                    var sql = (from a in objEntity.ToList()
                               ...
                               select new MatrizExcel
                               {
                                   ...
                                   Alergias = Habitos_Personales.Find(p => p.PersonId == a.IdTrabajador) == null ? " a" : Habitos_Personales.Find(p => p.PersonId == a.IdTrabajador).ListaPersonalMedical == null ? "b" : Habitos_Personales.Find(p => p.PersonId == a.IdTrabajador).ListaPersonalMedical.Find(p => p.v_DiseasesId == "N009-DD000000633") == null ? "NO" : Habitos_Personales.Find(p => p.PersonId == a.IdTrabajador).ListaPersonalMedical.Find(p => p.v_DiseasesId == "N009-DD000000633").i_Answer.ToString() == "1" ? "SI" : "NO",
                                   DetalleAlergia = Habitos_Personales.Find(p => p.PersonId == a.IdTrabajador) == null ? " a" : Habitos_Personales.Find(p => p.PersonId == a.IdTrabajador).ListaPersonalMedical == null ? "b" : Habitos_Personales.Find(p => p.PersonId == a.IdTrabajador).ListaPersonalMedical.Find(p => p.v_DiseasesId == "N009-DD000000633") == null ? "---" : Habitos_Personales.Find(p => p.PersonId == a.IdTrabajador).ListaPersonalMedical.Find(p => p.v_DiseasesId == "N009-DD000000633").i_Answer.ToString() == "1" ? Habitos_Personales.Find(p => p.PersonId == a.IdTrabajador).ListaPersonalMedical.Find(p => p.v_DiseasesId == "N009-DD000000633").v_DiagnosticDetail : "---",
                                   HipertensionArterial = Habitos_Personales.Find(p => p.PersonId == a.IdTrabajador) == null ? " a" : Habitos_Personales.Find(p => p.PersonId == a.IdTrabajador).ListaPersonalMedical == null ? "b" : Habitos_Personales.Find(p => p.PersonId == a.IdTrabajador).ListaPersonalMedical.Find(p => p.v_DiseasesId == "N009-DD000000436") == null ? "NO" : Habitos_Personales.Find(p => p.PersonId == a.IdTrabajador).ListaPersonalMedical.Find(p => p.v_DiseasesId == "N009-DD000000436").i_Answer.ToString() == "1" ? "SI" : "NO",
                                   AnteQuirurgicos = Habitos_Personales.Find(p => p.PersonId == a.IdTrabajador) == null ? "a" : Habitos_Personales.Find(p => p.PersonId == a.IdTrabajador).ListaPersonalMedical == null ? "b" : Habitos_Personales.Find(p => p.PersonId == a.IdTrabajador).ListaPersonalMedical.Find(p => p.v_DiseasesId == "N009-DD000000637") == null ? "NO" : Habitos_Personales.Find(p => p.PersonId == a.IdTrabajador).ListaPersonalMedical.Find(p => p.v_DiseasesId == "N009-DD000000637").i_Answer.ToString() == "1" ? "SI" : "NO",
                                   Gastritis = Habitos_Personales.Find(p => p.PersonId == a.IdTrabajador) == null ? " a" : Habitos_Personales.Find(p => p.PersonId == a.IdTrabajador).ListaPersonalMedical == null ? "b" : Habitos_Personales.Find(p => p.PersonId == a.IdTrabajador).ListaPersonalMedical.Find(p => p.v_DiseasesId == "N009-DD000000401") == null ? "NO" : Habitos_Personales.Find(p => p.PersonId == a.IdTrabajador).ListaPersonalMedical.Find(p => p.v_DiseasesId == "N009-DD000000401").i_Answer.ToString() == "1" ? "SI" : "NO",
                                   DiabetesMellitus = Habitos_Personales.Find(p => p.PersonId == a.IdTrabajador) == null ? "a" : Habitos_Personales.Find(p => p.PersonId == a.IdTrabajador).ListaPersonalMedical == null ? " b" : Habitos_Personales.Find(p => p.PersonId == a.IdTrabajador).ListaPersonalMedical.Find(p => p.v_DiseasesId == "N009-DD000000642") == null ? " NO" : Habitos_Personales.Find(p => p.PersonId == a.IdTrabajador).ListaPersonalMedical.Find(p => p.v_DiseasesId == "N009-DD000000642").i_Answer.ToString() == "1" ? "SI" : "NO",
            ...
            try
            {
                using (SigesoftEntitiesModel dbContext = new SigesoftEntitiesModel())
                {
                    ...
                    var sql = (from a in objEntity.ToList()
                               ...
                               let DxAudiometria = new ServiceBL().GetDiagnosticByServiceIdAndComponentSeguimiento(a.IdServicio, Constants.AUDIOMETRIA_SJ_ID)
