...
namespace NetPdf
{
    public class FichaMedicaOcupacional312
    {
                                                                    ...
                                                                    string filePDF)
        {
            ...
            {
                //Loco
                CellLogo = new PdfPCell(HandlingItextSharp.GetImage(infoEmpresaPropietaria.b_Image,null, null, 163, 40)) { HorizontalAlignment = PdfPCell.ALIGN_LEFT };
            }
            else
            {
            ...
            cells = new List<PdfPCell>()
                 {
                    ...
                    new PdfPCell(new Phrase(DataService.v_DocNumber, fontColumnValue)){ HorizontalAlignment = PdfPCell.ALIGN_LEFT},                                    
            ...
            columnWidths = new float[] { 15f, 15f, 7f, 5f, 5f, 5f, 5f, 5f, 8f, 9f };
            ...
            cells = new List<PdfPCell>()
                {
                   //fila
                    ...
                    new PdfPCell(new Phrase("Nro. HIJOS FALLECIDOS", fontColumnValue)){ Colspan = 2, HorizontalAlignment = PdfPCell.ALIGN_RIGHT},        
            ...
            cells = new List<PdfPCell>()
               {
                    ...
                    //fila
                    new PdfPCell(new Phrase("TRIAJE", fontColumnValue))
            ...
            string[] excludeComponents = {   Sigesoft.Common.Constants.PSICOLOGIA_ID,
                                                 ...
                                                 Sigesoft.Common.Constants.AUDIOMETRIA_SJ_ID,
            ...
            if (DataService.FirmaMedicoMedicina != null)
                cellFirma = new PdfPCell(HandlingItextSharp.GetImage(DataService.FirmaMedicoMedicina, null, null, 100, 35)) { HorizontalAlignment = PdfPCell.ALIGN_CENTER };
            else
