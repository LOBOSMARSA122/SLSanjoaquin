...
namespace Sigesoft.Node.WinClient.UI
{
    public partial class frmConsultaFacturacion : Form
    {
        ...
        private List<ServiceGridJerarquizadaList> GetData(int pintPageIndex, int? pintPageSize, string pstrSortExpression, string pstrFilterExpression)
        {
            ...
            var _objData = _serviceBL.GetServicesPagedAndFiltered_(ref objOperationResult, pintPageIndex, pintPageSize, pstrSortExpression, pstrFilterExpression, pdatBeginDate, pdatEndDate, _componentIds, FCI, FCF,0);
