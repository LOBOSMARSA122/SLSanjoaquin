...
namespace Sigesoft.Server.WebClientAdmin.UI.Auditar
{
    ...
    public partial class FRM033A : System.Web.UI.Page
    {
        ...
        protected void btnSaveRefresh_Click(object sender, EventArgs e)
        {
            ...
            _oServiceBL.ActualizarAptitudServicio(ref objOperationResult, Session["ServiceId"].ToString(), int.Parse(ddlAptitud.SelectedValue.ToString()),((ClientSession)Session["objClientSession"]).GetAsList(), txtComentario.Text,"","");
