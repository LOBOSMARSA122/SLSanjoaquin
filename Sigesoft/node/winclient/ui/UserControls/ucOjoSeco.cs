    ...
    public partial class ucOjoSeco : UserControl
    {
        ...
        public List<ServiceComponentFieldValuesList> DataSource
        {
            get
            {
                ...
                {
                    SaveValueControlForInterfacingESO("N009-OJS00000001", "0");
                }

                if (rbBordeParpados0.Checked)
                {
                    SaveValueControlForInterfacingESO("N009-OJS00000007", "0");
                }

                if (rbEscamasCostra0.Checked)
                {
                    SaveValueControlForInterfacingESO("N009-OJS00000013", "0");
                }

                if (rbOjosPegados0.Checked)
                {
                    SaveValueControlForInterfacingESO("N009-OJS00000019", "0");
                }

                if (rbSecreciones0.Checked)
                {
                    SaveValueControlForInterfacingESO("N009-OJS00000025", "0");
                }
                
                 if (rbSequedadOjo0.Checked)
                {
                    SaveValueControlForInterfacingESO("N009-OJS00000031", "0");
                }
                    
                if (rbSensacionArenilla0.Checked)
                {
                    SaveValueControlForInterfacingESO("N009-OJS00000037", "0");
                }
                    
                if (rbSensacionCuerpo0.Checked)
                {
                    SaveValueControlForInterfacingESO("N009-OJS00000043", "0");
                }
                        
                if (rbArdorQuema0.Checked)
                {
                    SaveValueControlForInterfacingESO("N009-OJS00000049", "0");
                }
                        
                if (rbPicor0.Checked)
                {
                    SaveValueControlForInterfacingESO("N009-OJS00000055", "0");
                }
                            
                if (rbMalestarOjo0.Checked)
                {
                    SaveValueControlForInterfacingESO("N009-OJS00000061", "0");
                }
                            
                if (rbCansancioOjos0.Checked)
                {
                    SaveValueControlForInterfacingESO("N009-OJS00000097", "0");
                }

                SaveValueControlForInterfacingESO("N009-OJS00000097", txtCansancioOjosPtje.Text);
