...
namespace Sigesoft.Node.WinClient.BE
{
    ...
    public partial class llenargrillasigesoftResultDto
    {
        ...
        [DataMember()]
        public Nullable<Int32> T_REALIZADO { get; set; }

        public llenargrillasigesoftResultDto()
        {
        }

        public llenargrillasigesoftResultDto(String t_EmpresaCliente, String t_Id_Servicio, String t_Nombre_Completo, String t_Id_Componente, Nullable<Decimal> t_Total, String t_GESO, String t_IdProtocolo, String t_Categoria, String t_ServiceComponenteId, Nullable<Int32> t_REALIZADO)
        {
