...
namespace Sigesoft.Node.WinClient.BLL
{
   public class CalendarBL
   {
       ...
       public List<CalendarList> GetCalendarsPagedAndFiltered_(ref OperationResult pobjOperationResult, int? pintPageIndex, int? pintResultsPerPage, string pstrSortExpression, string pstrFilterExpression, DateTime? pdatBeginDate, DateTime? pdatEndDate, int? pintIsCampania)
       {
           ...
           try
           {
               ...
               var query = from A in dbContext.calendar
                           ...
                           where A.i_IsDeleted == 0 && D.i_IsCapanias == pintIsCampania
       ...
       public List<CalendarList> GetCalendarsPagedAndFiltered(ref OperationResult pobjOperationResult, int? pintPageIndex, int? pintResultsPerPage, string pstrSortExpression, string pstrFilterExpression, DateTime? pdatBeginDate, DateTime? pdatEndDate, int? pintIsCampania)
       {
       ...
       public string AddShedule(ref OperationResult pobjOperationResult, calendarDto pobjDtoEntity, List<string> ClientSession, string pstrProtocolId, string pstrPacientId, int pstrMasterServiceId, string pstrNuevoContinuacion, int? pintIsCampania)
       {
           //mon.IsActive = true;
           string NewId = "(No generado)";
           string ServiceId = String.Empty;
           ...
           try
           {
               ...
               objServiceDto.i_IsCapanias = pintIsCampania;
       ...
       public void Reschedule(ref OperationResult pobjOperationResult, List<string> ClientSession, string pstrCalendarId, DateTime pdatDateTimeStar, int pintddlVipId, string pstrProtocolId, string pstrPacientId, int pstrMasterServiceId)
       {
           ...
           try
           {
               ...
               string Result = AddShedule(ref pobjOperationResult, objCalendarDto, ClientSession, pstrProtocolId, pstrPacientId, pstrMasterServiceId,"Nuevo",0);
       ...
       public List<CalendarList> GetPacientInLineByComponentId1(ref OperationResult pobjOperationResult, int? pintPageIndex, int? pintResultsPerPage, string pstrSortExpression, string pstrComponentId, DateTime CurrentDate, string[] pobjComponentIds,int? pintIscampania)
       {
           ...
           try
           {
               ...
               var query = from A in dbContext.calendar
                           ...
                           where A.i_IsDeleted == isDeleted &&
                                 ...
                                 D.i_IsRequiredId == isRequired && C.i_IsCapanias==pintIscampania
               ...
               //List<CalendarList> objData11 = query.ToList();
               ...
               //.OrderByDescending(p=> p.d_ServiceDate);
       ...
       public List<CalendarList> GetHeaderRoadMap_(string calendarId)
       {
