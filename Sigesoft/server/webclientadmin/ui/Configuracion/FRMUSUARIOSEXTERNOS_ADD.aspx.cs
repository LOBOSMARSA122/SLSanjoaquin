        ...
        private void LoadData()
        {
            ...
            else if (Mode == "Edit")
            {
               ...
               var EmpresaId_ProtocoloId =  _protocolBL.ObtenerEmpresaPorSystemUserId(systemUserId);
                ddlEmpresaCliente.SelectedValue = EmpresaId_ProtocoloId == null ? "-1" : EmpresaId_ProtocoloId.EmpresaId;
                //Obtener Los permisos por el ProtocolId
                var Permisos = _protocolBL.ObtenerPermisosPorProtocoloId(EmpresaId_ProtocoloId== null?"":EmpresaId_ProtocoloId.ProtocoloId, systemUserId);
